...
This repository is a poc to show Karate test coverage using Jacoco. Base code with Spring & Karate test cases was taken from https://github.com/Sdaas/hello-karate
Only necessary changes was done to include Jacoco coverage report generation. 
Also added nationality to Person entity and adjust test case to reflect null for the field.
